...
const AdminSetup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Sign out so they need to sign in again with their new role
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-blue-50 p-3 rounded-md">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>This will create your account and grant you national administrator privileges.</p>
                </div>
              </div>
            </div>
            ...
            <Button 
              type="submit" 
              className="w-full" 
              disabled={isSubmitting || createFirstAdmin.isPending}
            >
              {isSubmitting || createFirstAdmin.isPending ? 'Creating Admin Account...' : 'Create First Admin'}
            </Button>
          </form>
        </CardContent>
      </Card>
